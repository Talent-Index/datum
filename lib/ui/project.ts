...
export interface Session {
  ...
  account: { id: number; role: string; display_name: string; address: string; kyc_status: string; phone: string | null; email: string | null; email_verified: boolean; fee_required: boolean } | null;
  operator: boolean;
}
